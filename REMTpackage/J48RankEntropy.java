...
import weka.classifiers.trees.REMTpackage.C45RankEntropyModelSelection;
import weka.classifiers.trees.j48.*;
import weka.core.*;
...
/**
 * Created by pc on 01/02/2016.
 */
public class J48RankEntropy extends AbstractClassifier implements OptionHandler, Drawable,
  ...
  //  protected boolean m_binarySplits = false;
    ...
    public String globalInfo() {
        ...
        return "Class for generating a pruned or unpruned C4.5 decision tree for ordinal data using REMT. For more "
    ...
    public TechnicalInformation getTechnicalInformation() {
        ...
        result.setValue(TechnicalInformation.Field.AUTHOR, "Niva Hazon & Saar Tal");
        result.setValue(TechnicalInformation.Field.YEAR, "2016");
        result.setValue(TechnicalInformation.Field.TITLE, "C4.5: REMT ");
        result.setValue(TechnicalInformation.Field.PUBLISHER, "NA");
        result.setValue(TechnicalInformation.Field.ADDRESS, "Tel-Aviv, IL");
    ...
    public void buildClassifier(Instances instances) throws Exception {
        ...
        ModelSelection modSelection = new C45RankEntropyModelSelection(m_minNumObj, instances,
    ...
    public String toString() {
        ...
        if (m_unpruned) {
            return "J48 REMT unpruned tree\n------------------\n" + m_root.toString();
        } else {
            return "J48 REMT pruned tree\n------------------\n" + m_root.toString();
        }
    }
