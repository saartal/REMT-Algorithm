 ...
 */
public class C45RankEntropyModelSelection extends ModelSelection {
     ...
     */
    public C45RankEntropyModelSelection(int minNoObj, Instances allData,
    ...
    public final ClassifierSplitModel selectModel(Instances data) {
        ...
        double minResult;
        C45RankEntropySplit[] currentModel;
        C45RankEntropySplit bestModel = null;
        NoSplit noSplitModel = null;
        double averageFRMI=0;
        int validModels = 0;
        ...
        try {
            ...
            currentModel = new C45RankEntropySplit[data.numAttributes()];
            ...
            for (i = 0; i < data.numAttributes(); i++) {
                ...
                if (i != (data).classIndex()) {
                    ...
                    currentModel[i] = new C45RankEntropySplit(i, m_minNoObj, sumOfWeights,
                            m_useMDLcorrection);
                    ...
                    if (currentModel[i].checkModel()) {
                        if (m_allData != null) {
                            if ((data.attribute(i).isNumeric())
                                    ...
                                    (0.3 * m_allData.numInstances())))) {
                                averageFRMI=averageFRMI+currentModel[i].rmi();
                                validModels++;
                            }
                        } else {
                            averageFRMI=averageFRMI+currentModel[i].rmi();
            ...
            averageFRMI=averageFRMI/validModels;
            ...
            for (i = 0; i < data.numAttributes(); i++) {
                if ((i != (data).classIndex()) && (currentModel[i].checkModel())) {
                    if((currentModel[i].rmi() >= (averageFRMI - 1E-3))
                            && Utils.gr(currentModel[i].rmi(), minResult)){
                        bestAttribute=i;
                        bestModel = currentModel[i];
                        minResult = currentModel[i].rmi();
                    }
                }
            }
